...
if df.empty:
    ...
    raw_codes = [
        ...
        ("🇧🇷 Brazil +55", "+55"), ("🇨🇦 Canada +1", "+1"), ("🇨🇳 China +86", "+86"),
        ("🇫🇷 France +33", "+33"), ("🇩🇪 Germany +49", "+49"), ("🇭🇰 Hong Kong +852", "+852"),
        ("🇮🇳 India +91", "+91"), ("🇮🇩 Indonesia +62", "+62"), ("🇮🇹 Italy +39", "+39"),
        ("🇯🇵 Japan +81", "+81"), ("🇲🇴 Macau +853", "+853"), ("🇲🇾 Malaysia +60", "+60"),
        ("🇳🇱 Netherlands +31", "+31"), ("🇳🇿 New Zealand +64", "+64"), ("🇵🇭 Philippines +63", "+63"),
        ("🇸🇬 Singapore +65", "+65"), ("🇰🇷 South Korea +82", "+82"), ("🇪🇸 Spain +34", "+34"),
        ("🇨Ｈ Switzerland +41", "+41"), ("🇹🇼 Taiwan +886", "+886"), ("🇹🇭 Thailand +66", "+66"),
        ("🇬🇧 United Kingdom +44", "+44"), ("🇺🇸 United States +1", "+1"), ("🇻🇳 Vietnam +84", "+84")
    ]
    # 確保 A-Z 排序
    country_codes = sorted(raw_codes, key=lambda x: x[0])

    col_country, col_phone_num = st.columns([0.4, 0.6])
    with col_country:
        # 預設尋找香港的索引，如果找不到則預設為第一個
